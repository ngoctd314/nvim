...
M.ui = {
  ...
  hl_override = {
    ...
    IndentBlanklineChar = { fg = pallete.normal.fg, bg = pallete.normal.bg, bold = true },
    IndentBlanklineSpaceChar = { fg = pallete.normal.fg, bg = pallete.normal.bg, bold = true },
    IndentBlanklineContextChar = { fg = pallete.normal.fg, bg = pallete.normal.bg, bold = true },
    IndentBlanklineContextStart = { fg = pallete.normal.fg, bg = pallete.normal.bg, bold = true },
    -- Comment = { italic = true },
    -- ["@comment"] = { italic = true },
